 ...
 */
public class TreeLeaf extends JSONtreeBase{
...
//    }
    protected String valueToString(){
        ...
        if (this.isArray(this.get())) {
            return toStringArray(this.get());
        }
        if (this.isCollection(this.get())) {
            return toStringCollection(this.get() );
        }
        if (this.isMap(this.get())) {
            return toStringMap(this.get());
        }
        if(this.get() instanceof String){
            return  this.get()+"";
        }
        if(this.get() instanceof Character){
            return  this.get()+"";
        }
        if(this.get() instanceof JSONtree){
            return ((JSONtree)this.get()).toString();
        }
        if (this.isPrimitive(this.get())) {
            if (this.isString(this.get())) {
                return  "\"" + this.get() + "\"";
