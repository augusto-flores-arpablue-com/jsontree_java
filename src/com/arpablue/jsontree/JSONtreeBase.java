...
import com.arpablue.jsontree.StringManager;
...
class JSONtreeBase {
     ...
     * @return It is the string content the data of the JSONtreeBase
     */
    @Override
    ...
    */
    ...
    /**
     * It verify if the current value is a JSONtree.
     * @param target It it the object to verify if the is JSONtree object.
     * @return It is true if the object is a JSONtree.
     */
    public static boolean isThPath(Object target){
        return target instanceof JSONtree;
    }
    /**
    ...
    public static boolean isCollector(Object target){
        ...
        if( JSONtreeBase.isCollection(target)){
            return true;
        }
        if( JSONtreeBase.isMap(target)){
            return true;
        }
        if( JSONtreeBase.isThPath(true));
        return false;
    }
